        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width:100%">
                    ...
                    <li _ngcontent-c16="" class="active1" style="pointer-events:none"><a _ngcontent-c16="" href="kids-now/food/menu-food-name">@lang('kidsnow.edit')</a></li>
        ...
        <div class="row">
            <div class="mat-card">
                <div class="mat-content">
                    ...
                    <div>
                        <p>@lang('kidsnow.edit') @lang('kidsnow.food_name') *</p>
                        <form  style="width:auto;" method="post">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control" style="text-transform:capitalize" name="food_name" placeholder="Enter food name" value="{{ $foodname->food_name }}">
