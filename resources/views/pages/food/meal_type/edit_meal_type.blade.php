        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width:100%">
                    ...
                    <li _ngcontent-c16="" class="active-1" style="pointer-events:none"><a _ngcontent-c16="" href="kids-now/food/menu-meal-type">@lang('kidsnow.edit')</a></li>
                </div>
                </ul>
            </div>
        </div>
                ...
                <div class="mat-content">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="text-transform:capitalize" name="name" placeholder="Enter Meal Type" value="{{ $mealtype->name }}">
                            @if($errors->has('name'))
