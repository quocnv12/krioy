                ...
                <div class="mat-content">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control" id="email" placeholder="Enter Meal Type" name="email">
                        </div>
                    ...
                    <div>
                        <p>Add Quantity</p>
                        <div class="form-group">
                            <input type="email" class="form-control" id="email" placeholder="Enter Quantity" name="email">
                        </div>
                        <button type="submit" class="btn btn-default">Save</button>
                    </div>
                    <hr>
                    ...
                    <div>
                        <p>Add Name Food</p>
                        <div class="form-group">
                            <input type="email" class="form-control" id="email" placeholder="Enter Name Food" name="email">
                        </div>
                        <button type="submit" class="btn btn-default">Save</button>
                    </div>
