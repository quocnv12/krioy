<html>
	<head>
		<meta charset="utf-8">
		<title>Kriyo View Program</title>
		...
		<div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
			<div class="row">
				<ul class="ul-td">
					...
					<li _ngcontent-c16="" class="active1 active-1" style="pointer-events:none;"><a _ngcontent-c16="">VIEW PROGRAM</a></li>
				</ul>
			</div>
		</div>
		<div class="mat-card">
							...
							<div class="row" style="margin: 10px 0;" >
								...
								<div class="col-md-10" style="margin: 10px 0;">
									<div class="panel_new">
										...
										<div class="letterCircle listClass tablinks1_active" style="color: #5363d7;">T</div>
										<div class="letterCircle listClass" style="color: #5363d7;">W</div>
										<div class="letterCircle listClass" style="color: #5363d7;">T</div>
										<div class="letterCircle listClass tablinks1_active" style="color: #5363d7;">F</div>
										<div class="letterCircle listClass" style="color: #5363d7;">S</div>
									</div>
								</div>
							</div>
