            ...
            <div class="row">
                <div class="col-sm-6">
                    <ul class="ul-td">
                        ...
                        <li _ngcontent-c16="" class="active1"  ><a _ngcontent-c16="" href="{{route('admin.health.getAdd')}}">@lang('kidsnow.health')</a></li>
                        <li _ngcontent-c16="" class="active1 active-1" style="pointer-events:none" href=""><a _ngcontent-c16="">@lang('kidsnow.health.view_health')</a></li>
                    </ul>
                </div>
                {{--<div class="col-sm-6">--}}
                ...
                <div class="mat-card" style="width: 100%">
                    ...
                    <div class="update">
                        ...
                        <div id="Sick" class="tabcontent ">
                            <div class="row">
                                <div class="col-md-11 input_box">
                                    ...
                                    <input type="text" readonly name="sick" placeholder="@lang('kidsnow.health.sick_content') " value="{{$health->sick}}">
                                </div>
                            </div>
                        </div>
                        <div id="Medicine" class="tabcontent">
                            <div class="row">
                                <div class="col-md-11 input_box">
                                    <span class="input_box_span_active">@lang('kidsnow.health.medicine') *</span>
                                    <input type="text" readonly name="medicine" placeholder="@lang('kidsnow.health.medicine_content') " value="{{$health->medicine}}">
                                </div>
                            </div>
                        ...
                        <div id="Growth" class="tabcontent">
                            <div class="row growth">
                                <div class="col-md-4 growth_input input_box">
                                    <span class="input_box_span_active">@lang('kidsnow.health.growth_height')</span>
                                    <input type="text" readonly name="growth_height" placeholder="@lang('kidsnow.health.growth_height')" value="{{$health->growth_height}}">
                                ...
                                <div class="col-md-4 growth_input input_box">
                                    <span class="input_box_span_active">@lang('kidsnow.health.growth_weight')</span>
                                    <input type="text" readonly name="growth_weight" placeholder="@lang('kidsnow.health.growth_weight')" value="{{$health->growth_weight}}">
                                ...
                                <div class="col-md-4 growth_input input_box">
                                    <span class="input_box_span_active">@lang('kidsnow.health.growth_head_circumference')</span>
                                    <input type="text" readonly name="" placeholder="@lang('kidsnow.health.growth_head_circumference')" value="{{$health->growth_circumference}}">
                                    <label class="label">
                                        <div class="label-text">cm</div>
                                        <div class="toggle">
                                            <input class="toggle-state" type="checkbox" name="check" value="check" />
                            ...
                            <div class="row">
                                <div class="col-md-11 input_box">
                                    ...
                                    <input type="text" readonly name="growth" placeholder="@lang('kidsnow.health.growth_content')" value="{{$health->growth}}">
                        ...
                        <div id="Incident" class="tabcontent">
                            <div class="row">
                                <div class="col-md-11 input_box">
                                    ...
                                    <input type="text" readonly name="incident" placeholder="@lang('kidsnow.health.incident_content') " value="{{$health->incident}}">
                        ...
                        <div id="Blood_group" class="tabcontent">
                            <div class="row">
                                <div class="col-md-11 input_box">
                                    ...
                                    <input type="text" readonly name="blood_group" placeholder="@lang('kidsnow.health.blood_group_content') " value="{{$health->blood_group}}">
