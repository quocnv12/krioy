				...
				<div class="mat-content">
					...
					<div class="update">
						...
						<div class="tab">
							...
							<button class="tablinks" onclick="openCity(event, 'Growth')">Growth</button>
							<button class="tablinks" onclick="openCity(event, 'Incident')">Incident</button>
						</div>
						...
						<div id="Growth" class="tabcontent">
							<div class="row growth">
								<div class="col-md-4 growth_input input_box">
									<span>Height</span>
									<input type="text" name="number" placeholder="Height">
									<label class="label">
								...
								<div class="col-md-4 growth_input input_box">
									<span>Weight</span>
									<input type="text" name="number" placeholder="Weight">
									<label class="label">
								...
								<div class="col-md-4 growth_input input_box">
									...
									<input type="text" name="number" placeholder="Head Circumferen...">
									<label class="label">
										<div class="label-text">cm</div>
										<div class="toggle">
									    	<input class="toggle-state" type="checkbox" name="check" value="check" />
