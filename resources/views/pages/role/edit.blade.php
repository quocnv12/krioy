        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width:100%">
                    ...
                    <li _ngcontent-c16="" class="level1" style="pointer-events:none"><a _ngcontent-c16="" href="kids-now/role/edit">Edit</a></li>
                </ul>
            </div>
        </div>
        <div class="mat-card">
            <div class="mat-content">
                <p>Edit Role<label style="color:red">*</label></p>
                <form method="post">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control" style="text-transform:capitalize" name="role"
                    ...
                    <div class="row">
                        @foreach ($permissions as $item)
                            <div class="col-md-3 col-6" style="padding-left:40px"> 
                                ...
                                <input type="checkbox" name="permission[]" value="{{ $item->id }}" {{ $roleOfPermission->contains($item->id) ? 'checked' :'' }} >{{ $item->name }}
              ...
              <a href="kids-now/role"><button style="margin-top:20px" type="button" class="btn btn-primary">Cancel</button></a>    
                </form>
            </div>
        </div>
    </section>
