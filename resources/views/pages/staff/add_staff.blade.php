        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width: 100%;">
                    <li _ngcontent-c16="" class="level1"><a _ngcontent-c16="" href="kids-now">@lang('kidsnow.home')</a>
                    </li>
                    <li _ngcontent-c16="" class="active1"><a _ngcontent-c16=""
                            href="kids-now/staff">@lang('kidsnow.staff_profiles')</a></li>
                    <li _ngcontent-c16="" class="level1" style="pointer-events:none"><a _ngcontent-c16=""
                            href="kids-now/staff/add">@lang('kidsnow.add')</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2 textera-img">
                            <a style="cursor: pointer;">
                                ...
                                <img onerror="this.src='images/Staff100.png';" src="images/staff.png" alt="" id="demo_image" style="margin-top:50px">
                        ...
                        <div class="add a1 ">
                            <div class="row">
                                <div class="col-md-6 input_box">
                                    ...
                                    <input type="text" name="first_name" value="{{ old('first_name') }}"
                                        placeholder="@lang('kidsnow.first_name') *">
                                    @if($errors->has('first_name'))
                                    <p
                                        style="font-size: 12px;font-weight: 100;color:red;font-style: italic;line-height: 25px;margin-bottom: 0px;">
                                ...
                                <div class="col-md-6 input_box">
                                    ...
                                    <input type="text" name="last_name" value="{{ old('last_name') }}"
                                        placeholder="@lang('kidsnow.last_name') *">
                            ...
                            <div class="row">
                                <div class="col-md-6 input_box">
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone') }}"
                                        placeholder="@lang('kidsnow.phone_number') *">
                                    @if($errors->has('phone'))
                                    <p
                                        style="font-size: 12px;font-weight: 100;color:red;font-style: italic;line-height: 25px;margin-bottom: 0px">
                            ...
                            <div class="input_box" style="width: 100%;">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}"
                                    placeholder="@lang('kidsnow.email_address') *">
                                @if($errors->has('email'))
                                <p
                                    style="font-size: 12px;font-weight: 100;color:red;font-style: italic;line-height: 25px;margin-bottom: 0px">
                ...
                <div class="add">
                    <div class="input_box" style="width: 100%;">
                        ...
                        <input type="text" name="address" value="{{ old('address') }}"
                            placeholder="@lang('kidsnow.residential_address') *">
                        @if($errors->has('address'))
                        <p style="font-size: 12px;font-weight: 100;color:red;font-style: italic;line-height: 25px;margin-bottom: 0px">*
                ...
                <div class="add">
                    <div class="row">
                        <div class="col-md-4 input_box">
                            ...
                            <input style="color: #614545;" type="date" value="{{ old('date_birthday') }}"
                                name="date_birthday" placeholder="@lang('kidsnow.birthday') *">
                        ...
                        <div class="col-md-4 input_box">
                            ...
                            <input style="color: #614545;" type="date" value="{{ old('date_of_joining') }}"
                                name="date_of_joining" placeholder="@lang('kidsnow.date_of_joining')">
