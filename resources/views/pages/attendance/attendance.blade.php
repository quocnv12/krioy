            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <a style="min-width:110px;background:#eb87c1;color:white; float: right; border: none;font-weight: bold"
                        href="{{route('attendance.list')}}" class="btn btn-success">CHILDREN LIST</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <form style="width: auto;margin: 0;text-align: center" method="post"
            ...
            <div class="mat-card tab-content" style="min-height: 500px;">
                <div class="mat-content" id="tab-main">
                    <div _ngcontent-c19="" class="row ng-star-inserted">
                        ...
                        <div _ngcontent-c19=""
                            class="div_box_children col-lg-2 col-md-2 col-sm-2 col-xs-6 ng-star-inserted"
                            ...
                            <div _ngcontent-c19="" class="child-class"
                                ...
                                <i _ngcontent-c9="" aria-hidden="true" class="fa fa-check" id="checked"
                        ...
                        <div style="margin: 50px;">
                            ...
                            <span>Click on a program tab in horizontal scroll bar to show all children in that
                                program</span>
                        </div>
            ...
            <div class="icon-plus-1">
                <button type="button" class="icon-plus-button groupStatus" style="background-color: #37bd9c;"
                    data-toggle="modal" data-target=".bd-example-modal-sm" value="1" name='status'>IN</button><br>
                <button type="button" class="icon-plus-button groupStatus" style="background-color: #ccc;"
                    data-toggle="modal" data-target=".bd-example-modal-sm" value="2" name='status'>OUT</button><br>
                <button type="button" class="icon-plus-button groupStatus" style="background-color: #ed5564;"
                    data-toggle="modal" data-target=".bd-example-modal-sm" value="3" name='status'>ABSENT</button><br>
