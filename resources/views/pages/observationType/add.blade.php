        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width:100%">
                    ...
                    <li _ngcontent-c16="" class="active-1" style="pointer-events:none"><a _ngcontent-c16="" href="">@lang('kidsnow.observation_type.add_observation_type')</a></li>
        ...
        <div class="row">
            <div class="mat-card">
                <div class="mat-content">
                    ...
                    <div>
                        <form action="{{route('admin.observationtype.add')}}" style="width:auto;" method="post">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" style="text-transform:capitalize" name="name"  placeholder="@lang('kidsnow.observations.observation_types')" value="{{ old('name') }}">
                                @if($errors->has('name'))
