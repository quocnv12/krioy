        ...
        <div class="tieu-de" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="row">
                <ul class="ul-td" style="width:100%">
                    ...
                    <li _ngcontent-c16="" class="active1"><a _ngcontent-c16="" href="">ObservationType</a></li>
                    ...
                    <div>
                        ...
                        <form  style="width:auto;" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" style="text-transform:capitalize" name="name"  placeholder="Enter Observation Type" value="{{ old('name') }}">
                                @if($errors->has('name'))
